...
\begin{tikzpicture}
    \begin{class}[text width=\umlwidth]{FileManager}{0, 0}
        ...
        \operation{+ listdir() : List(String)}
        \operation{+ \_\_getitem\_\_(filepath : String) : InputFile}
...
\todo{Either make the whole thing static or let the constructor take a \texttt{types} parameter and initialize a single instance.\\
Current solution: instanciate it whenever needed.}
