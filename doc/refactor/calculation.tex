...
\begin{tikzpicture}
    \begin{class}[text width=\umlwidth]{Calculation}{0, 0}
        ...
        \operation{+ getresults(inputfile : InputFile, frame : Integer, resolution : Integer) : Results}
...
\texttt{calculate} either loads results from cache or calculates them.
...
\begin{tikzpicture}
    ...
    \end{class}
\end{tikzpicture}
\\\todo{Alternatives to \texttt{\_\_getitem\_\_} and \texttt{\_\_contains\_\_}}
